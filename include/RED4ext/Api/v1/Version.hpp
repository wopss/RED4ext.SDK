...
#define RED4EXT_V1_SDK_CURRENT_VERSION RED4EXT_V1_SEMVER(RED4EXT_VER_MAJOR, RED4EXT_VER_MINOR, RED4EXT_VER_PATCH)

/**
 * @brief Defines the legacy SDK version v0.5.0 for backward compatibility.
 *
 * @deprecated Use `RED4EXT_V1_SDK_CURRENT_VERSION`. Maintained for compatibility with older loaders and may be removed
 * in a future release.
 *
