...
using CBaseRTTIType [[deprecated("Use rtti::IType")]] = rtti::IType; 
using CClass [[deprecated("Use rtti::ClassType")]] = rtti::ClassType; 
...
struct TTypedClass : CClass
{
    ...
    TTypedClass(CName aName, rtti::ClassType::Flags aFlags = {.isNative = true})
